...
class ComputedFieldDefinition extends BaseFieldDefinition implements ComputedFieldDefinitionWithValuePluginInterface {
  ...
  public function getSetting($setting_name) {
    // Allow the computed field plugin to return something first.
    $plugin_setting_value = $this->getFieldValuePlugin()->getFieldDefinitionSetting($setting_name);
    if (!is_null($plugin_setting_value)) {
