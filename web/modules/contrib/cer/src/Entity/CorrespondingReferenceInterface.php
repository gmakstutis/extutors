...
interface CorrespondingReferenceInterface extends ConfigEntityInterface {
  ...
  /**
   * Gets the direction new entities should be added.
   *
   * @return string
   *   'prepend' will add items at the top, 'append' will add items at the bottom.
   */
  public function getAddDirection();

  /**
   * Sets the direction new entities should be added.
   *
   ...
   * @return $this
   */
  public function setAddDirection($direction);
